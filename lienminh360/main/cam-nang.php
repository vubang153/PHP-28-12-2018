...
<div id="wrappertingame" style="width: 1164px; height: auto;margin:auto; background-color: white;">
	...
	<div style="width: 770px;height: 34px;border-bottom: 2px solid green; margin-top: 15px;">
		<div style="color: white;width: 125px; background-color: green;height: 100%;text-align: center;">CẨM NANG</div>
